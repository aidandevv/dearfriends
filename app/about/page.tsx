...
export default function AboutPage() {
  return (
    <SiteShell>
      <main className="mx-auto w-full max-w-6xl px-6 pb-20 pt-32">
        <section className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          ...
          <div className="postal-card postal-card-plain animate-fade-up px-8 py-8">
        ...
        <section className="mt-16 grid gap-6 lg:grid-cols-[1fr_0.9fr]">
          <div className="postal-card postal-card-plain px-8 py-8">
        ...
        <section className="postal-card mt-16 bg-ink px-8 py-10 text-linen md:flex md:items-center md:justify-between md:gap-8">
